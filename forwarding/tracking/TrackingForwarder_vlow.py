...
class TrackingForwarder(RecurrentDetectionForwarder):
  def __init__(self, engine):
    ...
    # add iou threshold
    iou_matching_car = self.config.float("iou_matching_car", 0.7)
    iou_matching_pedestrain = self.config.float("iou_matching_pedestrain", 0.7)
    self.tracker_options = {"tracker": tracker, "reid_comp": tracker_reid_comp,
                            ...
                            "iou_matching_car": iou_matching_car,
                            "iou_matching_pedestrain": iou_matching_pedestrain}
