...
def process_sequence(seq, detections_path, add_masks, tracker_options, optical_flow_path, temp_out, n_timesteps=None,
  ...
  hyp_tracks = track_single_sequence_deepsort(tracker_options, det_boxes, det_scores, reid_features, det_classes,
...
def tune_model(detections_path, gt_path, output_path, optical_flow_path, temp_path, eval_path,
  ...
  tracker_options = {"tracker": "hungarian", "reid_comp": "euclidean",
                     ...
                     "association_threshold_car": 0.2,
                     "association_threshold_pedestrian": 0.4,
                     "keep_alive_car": 0,
                     ...
                     "lambda_car": 0.0,
                     "lambda_pedestrain": 0.0,
                     "iou_matching_car": 0.7,
                     "iou_matching_pedestrain": 0.7,
                     "box_offset": 50.0,
                     "box_scale": 0.02,
                     "new_reid": False}
  ...
  for i in range(num_experiments):
    ...
    if tune_what == "bbox_center":
      ...
      exp_options["iou_matching_car"] = random.uniform(0.5, 0.99)
      exp_options["iou_matching_pedestrain"] = random.uniform(0.5, 0.99)
      exp_options["association_threshold_car"] = random.uniform(0.0, 0.99)
      exp_options["association_threshold_pedestrian"] = random.uniform(0.0, 0.99)
      ...
      #exp_options["lambda_car"] = random.uniform(0.0, 0.99)
      #exp_options["lambda_pedestrain"] = random.uniform(0.0, 0.99)
